...
d);f.sessionFail(a,b)})}},sessionFail:function(a,b){if(!a){var d=c(".aui-dialog:visible");if(d.length)a=d.find(".dialog-panel-body").empty(),d.find(".aui-button").attr("disabled","disabled");else throw Error("sessionFail method really expected a visible dialog about now :/");}b||(b=AJS.format("\u60a8\u7684\u4f1a\u8bdd\u5df2\u7ecf\u8fc7\u671f\uff0c\u8bf7 {0}\u5237\u65b0{1}\u6b64\u9875\u9762\u540e\u91cd\u65b0\u5c1d\u8bd5\u3002",'<a class="reload" href="">',"</a>"),a.on("click","a.reload",function(){window.location.reload()}));AJS.messages.warning(a,{body:b,closeable:!1,shadowed:!0})},Binder:{placeFocus:function(){var a,
...
AJS.toInit(function(a){if(a("link[rel=canonical]").length){var c=null;a("#link-to-page-link").click(function(d){if(!c){c=(new AJS.Dialog(600,210,"link-page-popup")).addHeader("\u94fe\u63a5\u5230\u672c\u9875\u9762").addPanel("\u94fe\u63a5\u5230\u672c\u9875\u9762","<form id='link-page-popup-form' class='aui'><fieldset></fieldset></form>").addCancel("\u5173\u95ed",function(){c.hide();return!1});Confluence.KeyboardShortcuts&&Confluence.KeyboardShortcuts.enabled&&
c.addHelpText(AJS.format("Shortcut tip: Pressing \u003cb\u003e{0}\u003c/b\u003e also opens this dialog box","k"));var b=[{label:"\u94fe\u63a5",id:"link",value:a("link[rel=canonical]").attr("href")},{label:"\u5fae\u94fe\u63a5",id:"tiny-link",value:a("link[rel=shortlink]").attr("href")}];a.each(b,function(){a("#link-page-popup-form fieldset").append(AJS.format("<div class='field-group'><label for=''link-popup-field-{0}''>{1}:</label><input id=''link-popup-field-{0}'' readonly=''readonly'' value='''' class=''text'' type=''text''></div>",
...
jQuery(function(e){e(document).on("click","#manage-watchers-menu-item, .cw-manage-watchers",function(m){m.preventDefault();var c=new AJS.ConfluenceDialog({width:865,height:530,id:"manage-watchers-dialog",onCancel:function(){c.hide().remove()}});c.addHeader("\u7ba1\u7406\u5173\u6ce8\u4eba");c.addPanel("default",Confluence.Templates.ManageWatchers.dialogContent({pageId:AJS.Meta.get("page-id"),xsrfToken:AJS.Meta.get("atl-token")}));c.addCancel("\u5173\u95ed",function(){c.hide().remove();
...
username:c},error:function(){console.error("\u5220\u9664\u5173\u6ce8\u4eba\u5931\u8d25. \u5237\u65b0\u9875\u9762\u67e5\u770b\u6700\u65b0\u72b6\u6001\u3002");d.removeClass("removing")},success:function(){d.slideUp().remove();b.trigger("list-updated.manage-watchers",{list:e})}})});b.bind("list-updated.manage-watchers",function(a,b){var d=b.list;0<e("li.watch-user",d).length?(d.find(".no-users").addClass("hidden"),Confluence.Binder.userHover(),d.find(".confluence-userlink").each(function(){e(this).click(function(a){a.preventDefault()})})):d.find(".no-users").removeClass("hidden")});
...
"/json/pagechildren.action",type:"POST",data:{pageId:AJS.params.pageId,showChildren:!0},success:j,error:function(a,b){var c="\u4e0d\u80fd\u52a0\u8f7d\u5b50\u9875\u9762\u3002";h();d.html("<span class='error'>"+c+"</span>");AJS.log("Error retrieving child pages: "+b)}})):g(!0)}else g(!0);b.removeClass("children-hidden").addClass("children-showing")}return AJS.stopEvent(a)})})});
} catch (err) {
    if (console && console.log && console.error) {
        console.log("Error running batched script.");
        console.error(err);
...
AJS.Labels.openDialog(a):AJS.Labels.openDialog()})};AJS.Labels.openDialog=function(b){var a,g,e;d||(d=AJS.ConfluenceDialog({width:600,height:250,id:"edit-labels-dialog",onCancel:f}),d.addHeader("\u6807\u7b7e"),d.addPanel("Label Editor",Confluence.Templates.Labels.dialog()),d.addCancel("\u5173\u95ed",f),d.addHelpText("\u5feb\u6377\u952e\u63d0\u793a: \u67e5\u770b\u9875\u9762\u65f6, \u6309\u4e0b \u003cb\u003e{shortcut}\u003c/b\u003e \u4e5f\u80fd\u5f00\u542f\u6b64\u5bf9\u8bdd\u6846",{shortcut:"l"}),d.popup.element.find(".dialog-title").prepend(Confluence.Templates.Labels.helpLink()),c("#add-labels-form").submit(function(a){var b=
...
a=d(b).children(".shortcutsmenu");a.append(j("Block Formatting",["tinymce.block"],e));a.append(j("Rich Formatting",["tinymce.rich"],e));a.append(j("Editing Actions",["tinymce.actions"],e));return b}());c.addCancel("\u5173\u95ed",function(){AJS.debug("Hiding Shortcuts help");c.hide();return!1});c.popup.element.find(".dialog-title").prepend(Confluence.Templates.KeyboardShortcutsDialog.keyboardShortcutHelpLink());
